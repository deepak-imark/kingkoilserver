...
add_image_size( 'banner_slide', 1920, 951, true );
...
add_image_size( 'blog_image', 660, 306, true );
add_image_size( 'blog_single_image', 660, 306, true );
add_image_size( 'product_desc', 860, 631, true );
...
function custom_trip_slider() {
   $args = array(
      'label' => 'Tripadvisor Slider',
        'public' => true,
        'show_ui' => true,
        'capability_type' => 'post',
        'hierarchical' => false,
        'rewrite' => array('slug' => 'tripadvisor_slider'),
        'query_var' => true,
        'supports' => array(
            'title',
            'editor',
    ...
    register_post_type( 'tripadvisor_slider', $args );
}
add_action( 'init', 'custom_trip_slider' );
